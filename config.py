...
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","ZARA_MUSICBOT")
# --------------------------------------------------------
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/greatpersonxd/Doreamon1",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/PARADISE_SOCITEY")
SUPPORT_CHAT = getenv("SUPPORT_CHAT","https://t.me/QUIZ_HUB_GROUP")
